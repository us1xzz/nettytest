...
public class MessageTypeFilter {
    ...
    public static void  readFile_SendMessage(String input_filename,String output_filename,int mType){
...
//			        System.out.println("line " + line + ": " + tempString);
    ...
    public static void main(String args[]){
        ...
        if(args.length < 2){
            ...
            output_filename = "D:\\netty-practice\\nc_message_0616_night-massageType.log";
        }else{
        ...
        readFile_SendMessage(input_filename,output_filename,mType);
    }
